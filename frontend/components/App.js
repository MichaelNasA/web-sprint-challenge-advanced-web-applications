...
export default function App() {
  ...
  const getArticles = () => {
    ...
    axios
      ...
      .then((response) => {
        const { articles: fetchedArticles, message: articlesMessage } =
          response.data;
  ...
  const postArticle = (articleData) => {
    ...
    axios
      .post(articlesUrl, articleData, {
        headers: { Authorization: `${token}` },
      })
      .then((response) => {
        const { message: postMessage } = response.data;
        setMessage(postMessage);
        redirectToArticles();// update article state
      })
      .catch((error) => {
  ...
  const updateArticle = (articleId, articleData) => {
    ...
    axios
      .put(`${articlesUrl}/${articleId}`, articleData, {
        headers: { Authorization: `${token}` },
      })
      .then((response) => {
  ...
  const deleteArticle = (articleId) => {
    ...
    axios
      ...
      .then((response) => {
        ...
        // if needed don't refresh the page just update state
      })
      .catch((error) => {
